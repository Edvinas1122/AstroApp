/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ac5bae263681a3747e2d5d5f144832f1)
// Runtime types generated with workerd@1.20250508.0 2025-05-22 global_fetch_strictly_public,nodejs_compat
import { ChatService, UserService, AuthService, SocketUtilsService, LogService } from "@api/index";

declare namespace Cloudflare {
	interface Env {
		DEV: string;
		Log: LogService /* entrypoint Log from api */;
		User: UserService /* entrypoint User from api */;
		Auth: AuthService /* entrypoint Auth from api */;
		Chat: ChatService /* entrypoint Chat from api */;
		WebSocket: SocketUtilsService /* entrypoint SocketUtils from api */;
	}
}
