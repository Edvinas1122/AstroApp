/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: da1036ca5b4b9887f9ddffe1fd0091e7)
// Runtime types generated with workerd@1.20250508.0 2025-05-22 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		Words: Service /* entrypoint Words from api */;
		User: Service /* entrypoint User from api */;
		Auth: Service /* entrypoint Auth from api */;
		Chat: Service /* entrypoint Chat from api */;
		WebSocket: Service /* entrypoint SocketUtils from api */;
		ASSETS: Fetcher;
	}
}
